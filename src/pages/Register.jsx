    ...
    <div className="flex min-h-[80vh] items-center justify-center p-4 sm:p-6 lg:p-8">
      <Card className="w-full max-w-md shadow-lg border-muted">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">Enter your details below to set up your profile</CardDescription>
        </CardHeader>
        ...
        <CardContent className="grid gap-4">
          ...
          <div className="relative flex items-center justify-center my-1">
            ...
            <span className="relative bg-card px-3 text-xs text-muted-foreground uppercase">Or traditional email</span>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-2">
              <Label htmlFor="name">Full Name</Label>
              <Input id="name" name="name" type="text" placeholder="John Doe" required value={formData.name} onChange={handleChange} disabled={isSubmitting} />
            </div>
            ...
            <div className="grid gap-2">
              ...
              <Input id="confirmPassword" name="confirmPassword" type={showPassword ? 'text' : 'password'} required value={formData.confirmPassword} onChange={handleChange} disabled={isSubmitting} />
            </div>
...
//       toast.error(mismatchError); // Feedback for validation error
//       return;
//     }
...
//       navigate('/'); 
//     } catch (err) {
//       const fallbackError = err.message || 'Failed to create an account. Please try again.';
//       setError(fallbackError);
//       toast.error(fallbackError); // Feedback for operational error
//     } finally {
//       setIsSubmitting(false);
//     }
//   };
